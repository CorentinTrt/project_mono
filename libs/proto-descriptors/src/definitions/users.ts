...
import type { UsersServiceClient as _users_v1_UsersServiceClient, UsersServiceDefinition as _users_v1_UsersServiceDefinition } from './users/v1/UsersService';
...
export interface ProtoGrpcType {
  users: {
    v1: {
      ...
      UsersService: SubtypeConstructor<typeof grpc.Client, _users_v1_UsersServiceClient> & { service: _users_v1_UsersServiceDefinition }
    }
  }
}
